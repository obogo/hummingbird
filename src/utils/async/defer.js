...
utils.async.defer = (function (undef) {
    ...
    var defer = function (alwaysAsync) {
         ...
         */
            , _promise = {
                ...
                then: function (fulfilled, failed) {
                    ...
                    return d.promise;
                }, success: promise_success, error: promise_error, otherwise: promise_error, apply: promise_apply, spread: promise_apply, ensure: promise_ensure, nodify: promise_nodify, rethrow: promise_rethrow, isPending: function () {
                    return !!(status === 0);
                }, getStatus: function () {
                    return status;
                }
        ...
        return /**@type deferred */ {
            promise: _promise, resolve: _resolve, fulfill: _resolve // alias
            , reject: _reject
        };
    };
